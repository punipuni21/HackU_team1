...
const ContentList: React.FC<Props> = ({ classname, colSize, title, icon, color, contents }) => {
    ...
    <div className={classname}>
      ...
      <GridList className={classes.gridList} cols={colSize}>
        {contents.map((content) => (
          <GridListTile key={content.src + content.text} className={classes.gridListTile}>
            <Button onClick={() => handleOpen(content)} className={classes.overall}>
